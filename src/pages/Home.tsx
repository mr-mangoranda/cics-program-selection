...
export default function Home({ onNavigate }: { onNavigate: (view: string) => void, key?: string }) {
  return (
    <motion.div 
      initial="hidden"
      animate="visible"
          ...
          <motion.div variants={itemVariant} className="flex flex-col items-center flex-1 w-full max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full justify-center">
              ...
              <motion.div 
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => onNavigate('it-database-roadmap')}
                variants={cardVariant} 
                className="bg-white/70 backdrop-blur-md rounded-3xl p-6 py-8 sm:py-6 flex flex-col items-center justify-center shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full sm:w-[200px] xl:w-[220px] aspect-auto sm:aspect-square group border-2 border-[#e0e7ff] hover:border-[#a5b4fc] relative z-10 opacity-70 hover:opacity-100 hover:shadow-[0_20px_40px_rgba(99,102,241,0.15)] cursor-pointer transition-all duration-300"
              >
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[#f0f6ff] group-hover:bg-[#4f46e5] flex items-center justify-center mb-4 relative overflow-hidden transition-all duration-300">
                  <div className="absolute inset-0 bg-blue-400/20 rounded-full blur-xl animate-pulse"></div>
                  <Database className="w-8 h-8 text-[#0c5ade] group-hover:text-white transition-colors duration-300 relative z-10" strokeWidth={2.5} />
                </div>
                <h3 className="text-base sm:text-lg font-bold text-[#1f2937] group-hover:text-[#4f46e5] transition-colors text-center">IT – DATA BASE</h3>
              </motion.div>
              ...
              <motion.div 
                whileHover={{ scale: 1.05, y: -5 }} 
                whileTap={{ scale: 0.98 }}
                onClick={() => onNavigate('it-networking-roadmap')}
                variants={cardVariant} 
              ...
              >
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[#f0f6ff] group-hover:bg-[#4f46e5] flex items-center justify-center mb-4 relative overflow-hidden transition-all duration-300">
                  ...
                  <Wifi className="w-8 h-8 text-[#4f46e5] group-hover:text-white transition-colors duration-300 relative z-10" strokeWidth={2.5} />
                </div>
                <h3 className="text-base sm:text-lg font-bold text-[#1f2937] group-hover:text-[#4f46e5] transition-colors text-center">IT – Networking</h3>
              </motion.div>
              ...
              <motion.div 
                whileHover={{ scale: 1.05, y: -5 }} 
                whileTap={{ scale: 0.98 }}
                onClick={() => onNavigate('it-system-roadmap')}
                variants={cardVariant} 
                className="bg-white/70 backdrop-blur-md rounded-3xl p-6 py-8 sm:py-6 flex flex-col items-center justify-center shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full sm:w-[200px] xl:w-[220px] aspect-auto sm:aspect-square group border-2 border-[#e0e7ff] hover:border-[#fbcfe8] relative z-10 opacity-70 hover:opacity-100 hover:shadow-[0_20px_40px_rgba(192,38,211,0.15)] cursor-pointer transition-all duration-300"
              >
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[#fdf2f8] group-hover:bg-[#c026d3] flex items-center justify-center mb-4 relative overflow-hidden transition-all duration-300">
                  <div className="absolute inset-0 bg-pink-400/20 rounded-full blur-xl animate-pulse"></div>
                  <FileSpreadsheet className="w-8 h-8 text-[#c026d3] group-hover:text-white transition-colors duration-300 relative z-10" strokeWidth={2.5} />
                </div>
                <h3 className="text-base sm:text-lg font-bold text-[#1f2937] group-hover:text-[#c026d3] transition-colors text-center">Information System</h3>
              </motion.div>
