...
import { itnwSubjectsData as subjectsData, itnwTimelineData as timelineData } from '../data/itNetworkingSubjects';

export default function ITNetworkingSubjects({ onNavigate }: { onNavigate: (view: string) => void, key?: string }) {
  ...
  return (
    ...
    >
      ...
      <RoadmapHeader onNavigate={onNavigate} currentView="subjects" track="itnw" />
      ...
      <main className="flex-grow flex flex-col items-center w-full max-w-7xl mx-auto px-6 lg:px-12 z-10 relative pb-32">
        ...
        >
          <h1 
            className="text-4xl md:text-5xl lg:text-7xl font-black text-center text-[#4f46e5] leading-tight mb-4"
            style={{ textShadow: "3px 3px 0px #c7d2fe" }}
          >
            IT-NW SUBJECTS DIRECTORY
          </h1>
          <p className="text-slate-500 font-medium max-w-2xl mx-auto">
            Browse through all the courses offered in the IT - Networking program. Use the search bar to find specific subjects by code or keyword.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="text-sm font-bold text-[#4f46e5] bg-indigo-50 px-3 py-1 rounded-full">
