...
export default function ITDatabaseRoadmap({ onNavigate }: { onNavigate: (view: string) => void, key?: string }) {
  ...
  return (
    ...
    >
      ...
      <RoadmapHeader onNavigate={onNavigate} currentView="roadmap" track="itdb" />
      ...
      <main className="flex-grow flex flex-col items-center w-full max-w-5xl mx-auto px-4 z-10 relative pb-32">
        ...
        >
          ...
          >
            <span className="block mb-2 md:mb-4">IT - DATABASE</span>
