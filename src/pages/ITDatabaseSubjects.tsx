...
import { itdbSubjectsData as subjectsData, itdbTimelineData as timelineData } from '../data/itDatabaseSubjects';

export default function ITDatabaseSubjects({ onNavigate }: { onNavigate: (view: string) => void, key?: string }) {
  ...
  return (
    ...
    >
      ...
      <RoadmapHeader onNavigate={onNavigate} currentView="subjects" track="itdb" />
      ...
      <main className="flex-grow flex flex-col items-center w-full max-w-7xl mx-auto px-6 lg:px-12 z-10 relative pb-32">
        ...
        >
          <h1 
            className="text-4xl md:text-5xl lg:text-7xl font-black text-center text-[#9300d8] leading-tight mb-4"
            style={{ textShadow: "3px 3px 0px #deafff" }}
          >
            IT-DB SUBJECTS DIRECTORY
          </h1>
          <p className="text-slate-500 font-medium max-w-2xl mx-auto">
            Browse through all the courses offered in the IT - Database Systems program. Use the search bar to find specific subjects by code or keyword.
          </p>
        </motion.div>
          ...
          <button
            ...
            className={`whitespace-nowrap px-5 py-2.5 rounded-full text-sm font-bold transition-all ${
              selectedSemester === 'All' 
                ? 'bg-[#9300d8] text-white shadow-md' 
        ...
        >
          ...
          <div className="text-sm font-bold text-[#9300d8] bg-purple-50 px-3 py-1 rounded-full">
