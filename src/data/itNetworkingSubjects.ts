export const itnwSubjectsData: Record<string, any> = {
  ...
  'CCC100': { code: 'CCC100', title: 'Fundamentals of Computing', description: 'Overview of computing, computers, and the Internet.', prerequisites: 'None', creditHours: '3 Units', instructor: 'CS Faculty', color: '#0ea5e9' },
  'CCC101': { code: 'CCC101', title: 'Computer Programming 1', description: 'Introduction to programming concepts, control structures, and basic algorithms.', prerequisites: 'None', creditHours: '3 Units', instructor: 'CS Faculty', color: '#8b5cf6' },
  ...
  'NST001': { code: 'NST001', title: 'National Service Training Program 1', description: 'Civic welfare training service.', prerequisites: 'None', creditHours: '(3)', instructor: 'NSTP Faculty', color: '#14b8a6' },
  ...
  'CCC102': { code: 'CCC102', title: 'Computer Programming 2', description: 'Advanced programming concepts, object-oriented programming principles.', prerequisites: 'CCC101', creditHours: '3 Units', instructor: 'CS Faculty', color: '#8b5cf6' },
  ...
  'CCC121': { code: 'CCC121', title: 'Data Structures and Algorithms', description: 'Design, implementation, and analysis of fundamental data structures and algorithms.', prerequisites: 'CCC102', creditHours: '3 Units', instructor: 'CS Faculty', color: '#8b5cf6' },
  ...
  'ITE112': { code: 'ITE112', title: 'Algorithmic Graph Theory', description: 'Algorithmic Graph Theory.', prerequisites: 'MAT104 and CCC101', creditHours: '3 Units', instructor: 'IT Faculty', color: '#f59e0b' },
  ...
  'ITE125': { code: 'ITE125', title: 'Introduction to Human Computer Interaction', description: 'Principles and practices of user interface design and evaluation.', prerequisites: 'CCC102', creditHours: '3 Units', instructor: 'IT Faculty', color: '#ec4899' },
  'ITE132': { code: 'ITE132', title: 'Fundamentals of Computer Networks', description: 'Data communication, network models, protocols, and security.', prerequisites: 'ITE131', creditHours: '3 Units', instructor: 'IT Faculty', color: '#ef4444' },
  'CCC151': { code: 'CCC151', title: 'Information Management', description: 'Database concepts, data modeling, relational databases, and SQL.', prerequisites: 'CCC121', creditHours: '3 Units', instructor: 'IT Faculty', color: '#3b82f6' },
  ...
  'ITE133': { code: 'ITE133', title: 'Advance Computer Networks', description: 'Advanced networking concepts, protocols, and network systems track implementation.', prerequisites: 'ITE132', creditHours: '3 Units', instructor: 'IT Faculty', color: '#2563eb' },
  'ISY108': { code: 'ISY108', title: 'Requirements Engineering', description: 'Elicitation, analysis, specification, and validation of software requirements.', prerequisites: 'CCC151', creditHours: '3 Units', instructor: 'IT Faculty', color: '#eab308' },
  'CCC181': { code: 'CCC181', title: 'Application Dev and Emerging Tech', description: 'Modern application development practices and emerging technologies.', prerequisites: 'CCC151', creditHours: '3 Units', instructor: 'IT Faculty', color: '#8b5cf6' },
  ...
  'TechElect1': { code: 'TechElect1', title: 'Technical Elective 1', description: 'Specialized topic in Network Systems.', prerequisites: 'ITE132', creditHours: '3 Units', instructor: 'IT Faculty', color: '#14b8a6' },
  ...
  'ITE153': { code: 'ITE153', title: 'Introdction to Artificial Intelligence and Expert Systems', description: 'Fundamental concepts of artificial intelligence and expert systems.', prerequisites: 'CCC121', creditHours: '3 Units', instructor: 'IT Faculty', color: '#f43f5e' },
  ...
  'ITE192': { code: 'ITE192', title: 'CAPSTONE 2 / Undergrad Thesis', description: 'Implementation and defense of the IT capstone project.', prerequisites: 'ITE191/ITE198', creditHours: '3 Units', instructor: 'IT Faculty', color: '#d946ef' },
  'TechElect2': { code: 'TechElect2', title: 'Technical Elective 2', description: 'Specialized topic in Network Systems.', prerequisites: 'ITE132', creditHours: '3 Units', instructor: 'IT Faculty', color: '#14b8a6' },
  'TechElect3': { code: 'TechElect3', title: 'Technical Elective 3', description: 'Specialized topic in Network Systems.', prerequisites: 'ITE132', creditHours: '3 Units', instructor: 'IT Faculty', color: '#14b8a6' },
  ...
  'ITE183': { code: 'ITE183', title: 'Web Systems and Technologies', description: 'Advanced web development and system integration.', prerequisites: 'CCC181', creditHours: '3 Units', instructor: 'IT Faculty', color: '#3b82f6' },
  ...
  'TechElect4': { code: 'TechElect4', title: 'Technical Elective 4', description: 'Specialized topic in Network Systems.', prerequisites: 'ITE132', creditHours: '3 Units', instructor: 'IT Faculty', color: '#14b8a6' },
  'TechElect5': { code: 'TechElect5', title: 'Technical Elective 5', description: 'Specialized topic in Network Systems.', prerequisites: 'ITE132', creditHours: '3 Units', instructor: 'IT Faculty', color: '#14b8a6' },
...
export const itnwTimelineData = [
  ...
  },
  {
    ...
    subjects: ['GEC109', 'ITE112', 'STT071', 'STT071.1', 'ITE125', 'ITE132', 'CCC151', 'PED004']
  },
  {
    semesterName: 'Third Year, First Semester',
    subjects: ['HIS003', 'FIL101', 'ITE133', 'ISY108', 'CCC181', 'ITE191', 'TechElect1']
  },
  {
